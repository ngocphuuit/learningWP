    ...
    public function load_select_data($database)
    {
        ...
        switch ($database) {
            ...
            case 'taxonomy':
                ...
                break;
            case 'revolution':
                $this->_field['blank'] = __('Select a Slideshow', 'angle-admin-td');
                global $wpdb;
            ...
            case 'layerslider':
                if (class_exists('LS_Sliders')) {
                    ...
                    $this->_field['blank'] = __('Please activate LayersSlider plugin', 'angle-admin-td');
                }
                break;
            case 'slideshow':
                $this->_field['blank'] = __('Select a Slideshow', 'angle-admin-td');
            ...
            case 'staff_featured':
                $this->_field['blank'] = __('Select a Staff member', 'angle-admin-td');
            ...
            case 'icons':
                ...
                break;
            case 'categories':
                //$this->_field['blank'] = __('all categories', 'angle-admin-td');
                $data = get_categories(array('orderby' => 'name', 'hide_empty' => '0'));
                break;
            case 'portfolios':
                $this->_field['blank'] = __('Select a Portfolio', 'angle-admin-td');
            ...
            case 'typekit_kits':
                ...
                if (isset($theme_options['unregistered']['typekit_kits'])) {
                    ...
                    if (!empty($kits_details)) {
                        $this->_field['blank'] = __('Select a kit', 'angle-admin-td');
