    ...
    class OxygennaOptions
    {
        ...
        public function admin_bar_menu($wp_admin_bar)
        {
            ...
            foreach ($this->option_pages as $option_page) {
                if ($option_page['main_menu'] == true) {
                    $wp_admin_bar->add_node(array('id' => THEME_SHORT , 'title' => THEME_NAME . ' ' . __('Theme', 'angle-admin-td') , 'href' => admin_url('admin.php?page=' . $option_page['slug'])));
                    break;
                }
            }
        ...
        public function create_option_pages()
        {
            ...
            if ($this->main_menu_page !== null) {
                ...
                // add main menu page
                add_object_page($this->main_menu_page['page_title'], $this->main_menu_page['main_menu_title'], 'manage_options', $this->main_menu_page['slug'], array(&$this , 'option_page_html'), $this->main_menu_page['main_menu_icon']);
            } else {
            ...
            <div class="wrap oxygenna-options-page">
                ...
                <form method="post" action="options.php">
                    ...
                    <div class="submit-footer">
                        <?php submit_button(__('Save Changes', 'angle-admin-td'), 'primary', 'save_changes'); ?>
                        <?php submit_button(__('Restore Defaults', 'angle-admin-td'), 'secondary', 'reset_options'); ?>
                    </div>
                </form>
            </div>
