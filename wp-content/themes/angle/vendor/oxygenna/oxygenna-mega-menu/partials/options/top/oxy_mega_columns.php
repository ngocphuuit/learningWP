...
<p class="field-widget oxy-widget description-wide">
    <label for="edit-menu-item-oxy-widget-<?php echo $item_id; ?>">
        <?php _e('Use Column As Widget', 'angle-admin-td'); ?><br />
        <?php $widget_select->render(); ?>
        <span class="description"><?php _e('This will set this column up to be used as a widget position.', 'angle-admin-td'); ?></span>
    </label>
</p>
<p class="field-url oxy_col_url description-wide">
    <label for="edit-menu-item-oxy_col_url-<?php echo $item_id; ?>">
        <?php _e('Column Title URL', 'angle-admin-td'); ?><br />
        ...
        <span class="description"><?php _e('Leave blank if column title is not linkable.', 'angle-admin-td'); ?></span>
    </label>
</p>
