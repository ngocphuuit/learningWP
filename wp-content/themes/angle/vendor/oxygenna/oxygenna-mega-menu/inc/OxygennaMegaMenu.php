...
class OxygennaMegaMenu
{
                    ...
                    if ('oxy_mega_columns' === $menu_item->object) {
                        ...
                        if ('on' === $oxy_widget) {
                            register_sidebar(array(
                                ...
                                'name'          => __('Menu', 'angle-admin-td') . ' - ' . $menu_item->title,
    ...
    public function current_screen($current_screen)
    {
        if ('nav-menus' === $current_screen->base) {
            ...
            if (count($menus) === 0) {
                $columns = array(
                    'col-md-3'  => __('One Quarter Column (1/4)', 'angle-admin-td'),
                    'col-md-4'  => __('One Third Column (1/3)', 'angle-admin-td'),
                );
    ...
    public function wp_ajax_oxy_save_menu()
    {
        ...
        if (0 == $nav_menu_selected_id) {
            ...
            if ($new_menu_title) {
                ...
                $messages[] = '<div id="message" class="error"><p>' . __('Please enter a valid menu name.', 'angle-admin-td') . '</p></div>';
            }
