...
class Swatch_wpml_language_selector extends OxygennaWidget {
    ...
    public function __construct() {
        $widget_options = array( 'description' => __( 'WPML Language Selector', 'angle-admin-td' ) );
        parent::__construct( 'swatch_wpml-language-selector-options.php', false, $name = THEME_NAME . ' - ' . __('WPML Language Selector Widget', 'angle-admin-td'), $widget_options );
    }
