...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="post-inner-content">
		...
		<div class="entry-content">
			...
			<?php $thoigian = get_post_meta($post->ID, 'thoi-gian', true); 
			if ($thoigian): ?>
				<b><font color="#ff0000">Thời gian</b></font>: <?php echo $thoigian; ?></b></font>
			<?php endif; ?>

			<br>

			<?php $diadiem = get_post_meta($post->ID, 'dia-diem', true);
			if ($diadiem): ?>
				<b><font color="#ff0000">Địa điểm</b></font>: <?php echo $diadiem; ?></b></font>
			<?php endif; ?>
